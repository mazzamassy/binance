...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Handle receive button click with timer
    if (receiveButton) {
    ...
    function startCountdown() {
        ...
        receiveButton.style.color = '#5E6673'; // Grigio
        receiveButton.style.cursor = 'not-allowed';
    ...
    function updateButtonText() {
        receiveButton.textContent = `Ricevi il codice (${timeLeft}s)`;
    }
    
    function resetReceiveButton() {
        receiveButton.disabled = false;
        receiveButton.style.color = '#F0B90B'; // Giallo originale
        receiveButton.style.cursor = 'pointer';
        receiveButton.textContent = 'Ricevi il codice';
    }
